...
//#define TEMP_ADC hadc2
#define VREFINT_ADC hadc3
...
void init_vrefint_reciprocal(void)
{
    ...
    for(i = 0; i < 200; i++)
    {
        total_adc += adcx_get_chx_value(&VREFINT_ADC , ADC_CHANNEL_VREFINT);
    }
...
//    fp32 temperate;
//
//    adcx = adcx_get_chx_value(&TEMP_ADC ,ADC_CHANNEL_TEMPSENSOR);
...
fp32 get_battery_voltage(void)
{
    ...
    adcx = adcx_get_chx_value(&BATTERY_ADC, ADC_CHANNEL_8);
